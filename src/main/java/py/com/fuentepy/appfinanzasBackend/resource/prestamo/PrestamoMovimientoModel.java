 ...
 */
@Data
@ApiModel(value = "prestamoMovimientoModel", description = "Ejemplo de para Movimiento de un Prestamo")
public class PrestamoMovimientoModel implements Serializable {
