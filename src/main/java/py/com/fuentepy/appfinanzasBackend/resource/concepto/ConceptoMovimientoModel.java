 ...
 */
@Data
@ApiModel(value = "conceptoMovimientoModel", description = "Ejemplo de para Movimiento de un Concepto")
public class ConceptoMovimientoModel implements Serializable {
